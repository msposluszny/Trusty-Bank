...
1. At the beginning, the class variable `temporaryClientData` is updated to store the data of the currently selected client.
2. This approach allows `loadClientData` to be called with `temporaryClientData` as a parameter, enabling a quick refresh of the tables after an operation, e.g. after withdrawal.
